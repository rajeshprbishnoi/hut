...
void main(){
	...
	// Front Circle color fill
	boundary_fill(200, 150, 3, 15);

	// Window color fill
	boundary_fill(315, 225, 6, 15);
	boundary_fill(318, 242, 3, 15);
	boundary_fill(358, 225, 6, 15);
	boundary_fill(352, 242, 3, 15);

	// Front Up color fill
	boundary_fill(200, 105, 5, 15);

	// Door Up color fill
	//boundary_fill(200, 190, 5, 15);

	// Door sides color fill
	boundary_fill(155, 195, 7, 15);
	boundary_fill(245, 195, 7, 15);

	// Roof color fill
	boundary_fill(210, 110, 6, 15);
	boundary_fill(253, 110, 6, 15);
	boundary_fill(295, 110, 6, 15);
	boundary_fill(337, 110, 6, 15);
	boundary_fill(235, 150, 6, 15);
	boundary_fill(278, 150, 6, 15);
	boundary_fill(328, 150, 6, 15);
	boundary_fill(370, 150, 6, 15);

	// GATE color fill
	boundary_fill(185, 255, 13, 15);
	boundary_fill(185, 265, 10, 15);
	boundary_fill(185, 282, 12, 15);
	boundary_fill(185, 295, 5, 15);
	boundary_fill(210, 255, 13, 15);
	boundary_fill(210, 265, 10, 15);
	boundary_fill(210, 282, 12, 15);
	boundary_fill(210, 295, 5, 15);
